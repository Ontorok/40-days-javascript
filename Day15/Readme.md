...
```
const arr = new Array("Rose", "Tulip", "Daisy", "Sunflower", "Lily");
```
...
console.log(flowers[flowers.length - 3]); //Sunflower
```
...
console.log(flowers); // ['Carnation', 'Rose', 'Tulip', 'Daisy', 'Sunflower', 'Lily', 'Orchid']
```
...
### 7: Create an array containing the name of your favorite foods(10 foods). Destructure the 6th food element from the array using destructuring.

#### Ans.:

```
const foods = ["Pizza","Burger","Sushi","Pasta","Biryani","Fried Chicken","Tacos","Ramen","Butter Chicken","Falafel"];
const [, , , , , friedChicken] = foods;
console.log(friedChicken); // Fried Chicken
```

### 8: Take out the last 8 food items from the above array using the Array destructuring. Hint: rest parameter.
...
### 021: Can you filter employees who work in the "Engineering" department?

### 022: Create a new array that combines employee names and department names in the format: "Alice (HR)".

### 023: Find the highest salary among employees.

### 024: Check if there is at least one employee in the "Sales" department.

### 025: Write a function to filter employees earning more than 6000.

### 026: Create an array of employee names only.

### 027: Calculate the total salary of all employees using

### 028: Is there any employee earning less than 5000?

### 029: Find the first employee who earns exactly 5100.

### 030: Find the last employee in the "HR" department.

### 031: Find the first employee in the "Marketing" department.

### 032: Check if all employees earn more than 4000.

### 033: Find the first employee in the "Sales" and "HR" department.

### 034: Verify if all employees belong to a department listed in the departments array.

### 035: Log each employee's name and department name to the console.

### 036: Extract all employee names into a single array.

### 037: Increment each employee's salary by 10%

### 038: Assume each employee can have multiple skills. Create an array of employee skills and flatten them. Example: [{name: "Alice", skills: ["Excel", "Management"]}, ...].

### 039: Find the total salary of all employees working in the "Engineering" department.

### 040: Check if there is any department where all employees earn more than 5000.
...
### 65: Group the following array elements based on age(Adult vs Non-Adult):
...
### 67: Find common elements between two arrays, [1, 2, 3, 4], [3, 4, 5, 6]
